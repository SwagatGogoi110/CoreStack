...
<p align="center">
  <img src="assets/CloudStack.svg" alt="CloudStack" width="500" />
</p>
...
CloudStack is a fast, free, and open-source local AWS service emulator built for developers who need reliable AWS services in development and CI without cost, complexity, or vendor lock-in.

## Supported Services

CloudStack emulates 51 AWS services. See the [Services Overview](services/index.md) for per-service operation counts, endpoints, and full protocol details.
