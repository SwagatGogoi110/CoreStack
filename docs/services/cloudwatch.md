...
CloudStack supports both CloudWatch Logs and CloudWatch Metrics.
...
|---|---|---|
| `CLOUDSTACK_SERVICES_CLOUDWATCHLOGS_ENABLED` | `true` | Enable or disable the CloudWatch Logs service |
| `CLOUDSTACK_SERVICES_CLOUDWATCHLOGS_MAX_EVENTS_PER_QUERY` | `10000` | Maximum events returned per `FilterLogEvents` / `GetLogEvents` call |
