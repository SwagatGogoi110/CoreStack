...
|---|---|---|
| `CLOUDSTACK_SERVICES_PIPES_ENABLED` | `true` | Enable or disable the service |
...
CloudStack emulates EventBridge Pipes with the following supported source and target types:
