...
CloudStack implements the CodeDeploy API — stored-state management for applications, deployment groups, and configs, plus real Lambda and ECS deployment execution with traffic shifting and lifecycle hooks.
...
|---|---|---|
| `CLOUDSTACK_SERVICES_CODEDEPLOY_ENABLED` | `true` | Enable or disable the service |
