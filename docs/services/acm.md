...
|---|---|---|
| `CLOUDSTACK_SERVICES_ACM_ENABLED` | `true` | Enable or disable the service |
| `CLOUDSTACK_SERVICES_ACM_VALIDATION_WAIT_SECONDS` | `0` | Seconds to wait before transitioning a certificate from `PENDING_VALIDATION` to `ISSUED` (0 = immediate) |
