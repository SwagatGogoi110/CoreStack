...
CloudStack emulates the AWS Resource Groups Tagging API for local tests that need
...
|---|---|---|
| `CLOUDSTACK_SERVICES_TAGGING_ENABLED` | `true` | Enable or disable the Resource Groups Tagging API service |
