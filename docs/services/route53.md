...
New zones use these nameservers (configurable via `CloudStack.services.route53.*`):
...
|---|---|---|
| `CLOUDSTACK_SERVICES_ROUTE53_ENABLED` | `true` | Enable or disable the service |
| `CLOUDSTACK_SERVICES_ROUTE53_DEFAULT_NAMESERVER1` | `ns-1.awsdns-01.org` | First default nameserver returned in delegation sets |
| `CLOUDSTACK_SERVICES_ROUTE53_DEFAULT_NAMESERVER2` | `ns-2.awsdns-02.net` | Second default nameserver |
| `CLOUDSTACK_SERVICES_ROUTE53_DEFAULT_NAMESERVER3` | `ns-3.awsdns-03.com` | Third default nameserver |
| `CLOUDSTACK_SERVICES_ROUTE53_DEFAULT_NAMESERVER4` | `ns-4.awsdns-04.co.uk` | Fourth default nameserver |
