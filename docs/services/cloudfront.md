...
|---|---|---|---|
| `CloudStack.services.cloudfront.enabled` | `CLOUDSTACK_SERVICES_CLOUDFRONT_ENABLED` | `true` | Enable or disable the service |
| `CloudStack.services.cloudfront.domain-suffix` | `CLOUDSTACK_SERVICES_CLOUDFRONT_DOMAIN_SUFFIX` | `cloudfront.net` | Domain suffix for generated distribution domain names |
