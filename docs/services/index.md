...
CloudStack emulates 52 AWS services on a single port (`4566`). All services use the real AWS wire protocol, your existing AWS CLI commands and SDK clients work without modification.
...
Before calling any service, configure your AWS client to point to CloudStack:
