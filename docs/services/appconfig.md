...
CloudStack supports AWS AppConfig and AppConfigData for local configuration management.
...
|---|---|---|
| `CLOUDSTACK_SERVICES_APPCONFIG_ENABLED` | `true` | Enable or disable the AppConfig management plane |
| `CLOUDSTACK_SERVICES_APPCONFIGDATA_ENABLED` | `true` | Enable or disable the AppConfigData retrieval plane |
