...
CloudStack supports Application Load Balancers (ALB) and Network Load Balancers (NLB) through the ELBv2 management API. This is a Phase 1 implementation: the full CRUD control plane is available and AWS SDK / CLI / Terraform compatible. Data-plane traffic forwarding (actual TCP listener ports) is planned for Phase 2.
...
|---|---|---|
| `CLOUDSTACK_SERVICES_ELBV2_ENABLED` | `true` | Enable or disable the ELBv2 service |
