...
|---|---|---|
| `CLOUDSTACK_SERVICES_SECRETSMANAGER_ENABLED` | `true` | Enable or disable the service |
| `CLOUDSTACK_SERVICES_SECRETSMANAGER_DEFAULT_RECOVERY_WINDOW_DAYS` | `30` | Days before a deleted secret is permanently purged |
