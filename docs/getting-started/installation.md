...
CloudStack can be run three ways: as a Docker image, as a pre-built native binary, or built from source.
...
```bash
docker pull CloudStack/CloudStack:latest
```
