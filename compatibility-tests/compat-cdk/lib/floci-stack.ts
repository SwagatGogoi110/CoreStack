...
export class CloudStackTestStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const queue = new sqs.Queue(this, 'TestQueue', {
      queueName: 'CloudStack-cdk-test-queue',
      visibilityTimeout: cdk.Duration.seconds(30),
    });

    const table = new dynamodb.TableV2(this, 'TestTable', {
      tableName: 'CloudStack-cdk-test-table',
    ...
    const indexTable = new dynamodb.TableV2(this, 'IndexTestTable', {
      tableName: 'CloudStack-cdk-index-table',
      partitionKey: { name: 'pk', type: dynamodb.AttributeType.STRING },
    ...
    const generatedSecret = new secretsmanager.CfnSecret(this, 'GeneratedSecret', {
      name: 'CloudStack-cdk-generated-secret',
    ...
    // ECR repository (via CloudStack's emulated ECR + registry:2), and CloudStack's
    // Lambda runner pulls the image at invoke time.
    new lambda.DockerImageFunction(this, 'DockerHelloFn', {
      functionName: 'CloudStack-cdk-docker-hello',
    ...
    new cdk.CfnOutput(this, 'GeneratedSecretName', { value: generatedSecret.name || 'CloudStack-cdk-generated-secret' });
  }
}
