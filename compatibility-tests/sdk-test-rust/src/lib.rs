//! Shared test utilities for CloudStack SDK tests.

use aws_config::BehaviorVersion;
use aws_credential_types::Credentials;

/// Returns the CloudStack endpoint from environment or default.
pub fn endpoint() -> String {
    std::env::var("CLOUDSTACK_ENDPOINT").unwrap_or_else(|_| "http://localhost:4566".into())
}

/// Returns a base AWS SDK config for the CloudStack endpoint.
