 ...
 *
 * <p>These tests require the CloudStack instance to be running with
 * {@code CloudStack.services.iam.enforcement-enabled=true}.
...
class IamEnforcementTest {
    ...
    private static void assumeEnforcementEnabled() {
        Assumptions.assumeTrue(enforcementEnabled,
                "IAM enforcement is not enabled — set CloudStack.services.iam.enforcement-enabled=true to run these tests");
    }
