...
/**
 * Verifies that a Lambda container can resolve a public hostname through CloudStack's embedded DNS
 * server, which forwards non-CloudStack names to its upstream / configured fallback resolvers.
 *
 * <p>Regression for <a href="https://github.com/CloudStack-io/CloudStack/issues/1110">#1110</a>: public
